...
const shape=(name,cls)=>`<span class="${cls} sprite-shape" style="--sprite-mask:url('assets/${name==='body'?'ui-v13':'pet-v8'}/${name}.png')" aria-hidden="true">${part(name,'shape-source')}</span>`;
