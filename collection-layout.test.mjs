...
import {COLLECTION_PLACES,ownedPlaces} from './collection-layout.mjs';
import {ITEMS,GOALS,createProfile,restore} from './engine.mjs';
...
test('location art is local and pointer layers keep foreground dirt accessible',()=>{
 assert(existsSync(new URL('./assets/location-v15/planet-platforms.png',import.meta.url)));
 const css=readFileSync(new URL('./location-v15.css',import.meta.url),'utf8');
