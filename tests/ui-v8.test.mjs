...
const read=name=>readFileSync(projectURL(name,import.meta.url),'utf8');
...
test('v8 is the explicit final typography/layout layer with minimum readable body size',()=>{
 assert.match(read('./index.html'),/href="styles\/fonts.css"><link rel="stylesheet" href="styles\/polish-v8.css"/);
